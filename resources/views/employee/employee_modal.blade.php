...
<h2 class="card-titles" style="color: white;">Employee Information <i  style="float:right; cursor: pointer;" id="oth_library-ico" class="oth_library-ico"></i></h2>
                    ...
                    <div class="card-body">
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-md-3">
                                    <input type="number" class="form-control" id="emp_code" placeholder="Company ID Number ID Number">
                                </div>
                              <div class="col-md-2">
                            ...
                            <div class="row mt-2">
                                <div class="col-md-1">
                                    <label class='emp_label'> Branch</label>
                                </div>
                                <div class="col-md-3">
...
<h2 class="card-titles" style="color: white;">Salary Information <i  style="float:right; cursor: pointer;" id="oth_library-ico" class="oth_library-ico"></i></h2>
                    ...
                    <div class="card-body">
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-md-2">
                                    <label class="emp_label"> Monthly Rate</label>
                                </div>
                                <div class="col-md-3">
                                    <input type="number" class="form-control number" id="monthly_rate" placeholder="Monthly Rate">
                                </div>
